...
class DownloadTask:
    ...
    task_type: str = field(default="video")  # "video", "douyin_note", "zhihu_image", "douban_photo"
    ...
    async def _worker(self, origin: str) -> None:
        ...
        while True:
            ...
            try:
                ...
                elif task.task_type == "douban_photo":
                    from core.douban_photo import download_douban_images
